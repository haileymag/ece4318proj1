...
import pyaudio
import sys
# trying to assess how to add the tkinter within this qt5 gui
...
class Terrain(object):
    def __init__(self):
        ...
        self.window = pyqtgraph.opengl.GLViewWidget()
        ...
        wf = wave.open(r"Lanquidity.wav", 'rb')
        ...
        self.mesh1 = pyqtgraph.opengl.GLMeshItem(
            faces=faces,
            vertexes=verts,
            faceColors=colors,
            drawEdges=True,
